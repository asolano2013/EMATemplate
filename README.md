...
> For 0 to 5600 endpoints for a Demo Environment use the following template:
...
> For 0 to 5600 endpoints for a Production Environment use the following template:
